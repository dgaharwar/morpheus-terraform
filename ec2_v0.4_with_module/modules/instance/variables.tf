...
variable "ebs_block_device" {
  description = "WARNING Stop using ebs_block_device, please use submodule volume_attachment instead! This variable will have no effect due to its vulnerability to drifts."
  # type        = object
